...
using PracticeShoppingApp.Identity.Services;
using System.Text;
...
namespace PracticeShoppingApp.Identity
{
    public static class IdentityServiceExtensions
    {
        public static void AddIdentityServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDbContext<PracticeShoppingAppIdentityDbContext>(options => options.UseSqlServer(configuration.GetConnectionString("IdentityConnectionString"),
                b => b.MigrationsAssembly(typeof(PracticeShoppingAppIdentityDbContext).Assembly.FullName)));

            services.AddIdentity<ApplicationUser, IdentityRole>()
                .AddEntityFrameworkStores<PracticeShoppingAppIdentityDbContext>().AddDefaultTokenProviders();
